	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element min-vh-75">
			<div class="slider-inner">
						...
						<div class="row justify-content-center">
							<div class="col-md-7">
								<div class="slider-title mb-5 dark clearfix">
									<h2 class="text-white text-rotater mb-2" data-separator="," data-rotate="fadeIn" data-speed="3500">Enjoy Your <span class="t-rotate text-white">Day,Holiday,Birthday, Playday,Today,Weekday,Workday,Lovelyday,Valentineday,Freeday</span> With Holiyaay!.</h2>
									<p class="lead mb-0 text-uppercase ls2" style="color: #CCC; font-size: 110%">Scroll Down If You Want to Know More!
									</p>
								</div>
							</div>
						</div>
				...
				<div class="video-wrap">
					<video id="slide-video" poster="demos/course/images/video/videoplayback.mp4" preload="auto" loop autoplay muted>
						<source src='demos/course/images/video/videoplayback.mp4' type='video/mp4' />
					</video>
		...
		<section id="content">
			<div class="content-wrap" style="overflow: visible;">
						...
						<div class="row mt-2">
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Spanish Language Learning For Absolute Beginners</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Language</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Music Theory for Electronic Producers - The Complete Course!</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Music</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Ultimate Photoshop Training: From Beginner to Pro</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Design Tools</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Blockchain Advanced Level: Uses Beyond Bitcoin 2021</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Business</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Cognitive Behavioural Therapy (CBT) Practitioner Certificate</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Health & Fitness</a></p>
							...
							<div class="col-md-4 mb-5">
								<div class="card course-card hover-effect border-0">
									...
									<div class="card-body">
										<h4 class="card-title font-weight-bold mb-2"><a href="#">Masterclass: Start Your Food Business 7 courses in 1</a></h4>
										<p class="mb-2 card-title-sub text-uppercase font-weight-normal ls1"><a href="#" class="text-black-50">Food Recipes</a></p>
										<div class="rating-stars mb-2"><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star-half"></i> <span>4.4</span></div>
										<p class="card-text text-black-50 mb-1">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
									<div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted">
				...
				<!-- Instructors Section
				============================================= -->
				<div class="section bg-transparent" id="instructor" style="padding: 60px 0 40px;">
					<div class="container">
					...
					<div class="container clearfix">
						<div class="row align-items-center">
							...
							<div class="col-12 col-lg-auto mt-4 mt-lg-0">
								<a href="#" class="button button-xlarge button-rounded nott ls0 font-weight-normal m-0">Start Now</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-md"  style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
							...
							<a href="#" class="mb-2 d-block"><i class="icon-line2-call-in mr-2"></i>+1-111-222-333</a>
							<a href="#"><i class="icon-line2-envelope mr-2"></i>info@canvas.com</a>
						</div>
						<div class="col-6 col-md">
							<h4 class="text-uppercase ls2 font-weight-normal">Best Courses</h4>
						...
						<div class="col-6 col-md col-sm mt-4 mt-md-0 mt-lg-0 mt-xl-0">
							<h4 class="text-uppercase ls2 font-weight-normal">Support</h4>
							<ul class="list-unstyled mb-0">
								<li><h5 class="mb-2 font-weight-normal"><a href="#">My Account</a></h5></li>
								<li><h5 class="mb-2 font-weight-normal"><a href="#">Become an Instructor</a></h5></li>
								<li><h5 class="mb-2 font-weight-normal"><a href="#">Free Courses</a></h5></li>
								<li><h5 class="mb-2 font-weight-normal"><a href="#">Mobile Apps</a></h5></li>
								<li><h5 class="mb-2 font-weight-normal"><a href="#">Contact Us</a></h5></li>
							</ul>
						</div>
