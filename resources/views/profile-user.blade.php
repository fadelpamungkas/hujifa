								...
								<div class="col-lg-12">
									...
									<div class="tabs tabs-alt clearfix" id="tabs-profile">
										...
										<ul class="tab-nav clearfix">
											<li><a href="#tab-feeds"><i class="icon-rss2"></i> Pesanan</a></li>
											<li><a href="#tab-posts"><i class="icon-pencil2"></i> Semua Transaksi</a></li>
					...
					<div class="tab-content clearfix" id="tab-replies">
						...
						<div class="row">
							<form id="register-form" name="register-form" class="row mb-0" action="#" method="post">
								...
								<div class="col-12 form-group">
									<label for="register-form-password">ChangePassword:</label>
