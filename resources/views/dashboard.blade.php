	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row justify-content-between">
						...
						<nav class="primary-menu on-click">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="/portfolio"><div>Desa Wisata</div></a></li>
								<li class="menu-item"><a class="menu-link" href="/forms"><div>Daftar</div></a></li>
								<li class="menu-item"><a class="menu-link" href="/about"><div>Tentang Kami</div></a></li
								</li>
								</li>
							</ul>
						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									<h2 data-animate="fadeInUp">Admin Dashboard</h2>
									<p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium harum ea quo! Nulla fugiat earum, sed corporis amet iste non, id facilis dolorum, suscipit, deleniti ea. Nobis, temporibus magnam doloribus. Reprehenderit necessitatibus esse dolor tempora ea unde, itaque odit. Quos</p>
								</div>
							</div>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="promo promo-full promo-border py-5 header-stick bottommargin-lg">
					...
					<div class="row col-mb-50">
						<div class="col-sm-6 col-lg-3 text-center">
							...
							<div class="counter counter-large" style="color: #1abc9c;"><span data-from="0" data-to="$count" data-refresh-interval="30" data-speed="2000"></span></div>
							<h5>Jumlah Desa Wisata</h5>
						</div>

						<div class="col-sm-6 col-lg-3 text-center">
							<i class="i-plain i-xlarge mx-auto mb-0 icon-globe"></i>
							<div class="counter counter-large" style="color: #e74c3c;"><span data-from="0" data-to="170" data-refresh-interval="50" data-speed="2500"></span></div>
							<h5>Jumlah User</h5>
						</div>

						<div class="col-sm-6 col-lg-3 text-center">
							<i class="i-plain i-xlarge mx-auto mb-0 icon-gift"></i>
							<div class="counter counter-large" style="color: #3498db;"><span data-from="100" data-to="2154" data-refresh-interval="70" data-speed="3500"></span></div>
							<h5>Jumlah Pengunjung Website</h5>
						</div>

						<div class="col-sm-6 col-lg-3 text-center">
							<i class="i-plain i-xlarge mx-auto mb-0 icon-fire"></i>
							<div class="counter counter-large" style="color: #9b59b6;"><span data-from="0" data-to="31" data-refresh-interval="30" data-speed="2700"></span></div>
							<h5>Jumlah Pengajuan Desa Wisata</h5>
						</div>
					</div>
				</div>
		...
		var config = {
			data: {
				datasets: [{
					...
					label: 'Data Pengunjung Terbanyak' // for legend
				}],
				labels: [
					"Tamansari",
					"Tanjung",
			...
			options: {
				...
				title: {
					display: true,
					text: 'Data Pengunjung Terbanyak'
				},
				scale: {
				  ticks: {
					beginAtZero: true
