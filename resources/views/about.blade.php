		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="row align-items-stretch">
					...
					<div class="col-md-5 col-padding min-vh-75 order-md-last" style="background: url('images/team/5.jpg') center center no-repeat; background-size: cover;"></div>

					<div class="col-md-7 col-padding" style="background-color: #F5F5F5;">
						<div>
							<div class="heading-block">
								<span class="before-heading color">Web Designer</span>
								<h3>Muhammad Daffa Muafa</h3>
							</div>
				...
				<div class="row align-items-stretch">
					...
					<div class="col-md-5 col-padding min-vh-75" style="background: url('images/team/1.jpg') center center no-repeat; background-size: cover;"></div>

					<div class="col-md-7 col-padding">
						<div>
							<div class="heading-block">
								<span class="before-heading color">Digital Marketing</span>
								<h3>Muhammad Husni Tamiri</h3>
							</div>
				...
				<div class="row align-items-stretch bottommargin-lg">
					...
					<div class="col-md-5 col-padding min-vh-75 order-md-last" style="background: url('images/team/2.jpg') center center no-repeat; background-size: cover;"></div>
