	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap" style="overflow: visible;">
				...
				<div class="section mt-5 mb-0" style="padding: 120px 0; background-image: url('demos/course/images/icon-pattern-bg.jpg'); background-size: auto; background-repeat: repeat">
					...
					<div class="container">
						<div class="row">
								...
								<div class="row dark clearfix">
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											...
											<div class="fbox-content">
												<h3 class="text-white">Temukan Informasi Mengenai Desa Wisata</h3>
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											...
											<div class="fbox-content">
												<h3 class="text-white">Membeli Tiket</h3>
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											...
											<div class="fbox-content">
												<h3 class="text-white">Nikmati Liburan Anda</h3>
									...
									<div class="col-md-6">
										<div class="feature-box media-box bottommargin">
											...
											<div class="fbox-content">
												<h3 class="text-white">Beri Review dan Rating</h3>
												<p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi rem, facilis nobis voluptatum est voluptatem accusamus molestiae eaque perspiciatis mollitia.</p>
											</div>
										</div>
									</div>
							...
							<div class="widget">
								<h4>Our Instagram Latest Post!</h4>
								<div id="instagram-photos" class="instagram-photos masonry-thumbs grid-4 grid-sm-7 grid-lg-3" data-user="daffamuafa"></div>
							</div>
				...
				<!-- Promo Section
				============================================= -->
				<div class="section m-0" style="padding: 120px 0; background: #FFF url('demos/course/images/2.jpg') no-repeat left top / cover">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-5">
								<div class="heading-block border-bottom-0 mb-4 mt-5">
									<h3>Daftarkan Kampung Wisata Anda!</h3>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									<div class="fbox-icon">
										<i><img src="demos/course/images/instructor/5.jpg" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
									</div>
									<div class="fbox-content">
										<h3 class="mb-4 nott ls0"><a href="https://www.instagram.com/daffamuafa" class="text-dark">Muhammad Daffa Mu'afa</a><br><small class="subtitle nott color">Web Design</small></h3>
										<p class="text-dark mt-0"><strong>Email : </strong> Daffamuafa99@gmail.com</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									...
									<div class="fbox-content">
										<h3 class="mb-4 nott ls0"><a href="https://www.instagram.com/fadelpamungkas_" class="text-dark">Fadel Pamungkas</a><br><small class="subtitle nott color">Programmer</small></h3>
										<p class="text-dark"><strong>Email : </strong> Fadelpamungkas@gmail.com</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									...
									<div class="fbox-content">
										<h3 class="mb-4 nott ls0"><a href="https://www.instagram.com/prince.husni" class="text-dark">Muhammad Husni Tamiri</a><br><small class="subtitle nott color">Digital Marketing</small></h3>
										<p class="text-dark"><strong>Email : </strong> Husnitamiri@gmail.com</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 mb-4">
								<div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
									...
									<div class="fbox-content">
										<h3 class="mb-4 nott ls0"><a href="https://www.instagram.com/ajiperdanaa_" class="text-dark">Muhammad Aji Perdana</a><br><small class="subtitle nott color">Project Manager</small></h3>
										<p class="text-dark"><strong>Email : </strong> Ajiperdana@gmail.com</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="container clearfix">
						<div class="row align-items-center">
							<div class="col-12 col-lg">
								<h3 class="ls-1">Checkout our Instagram <span><a href="https://instagram.com/holiyaay.id">@holiyaay.id</a></span> or Email us at <span>holiyaay.id@gmail.com</span></h3>
